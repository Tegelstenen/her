...
export interface QuestionBoxHandle {
	showNextQuestion: (index: number) => void;
}

const QuestionBox = forwardRef<QuestionBoxHandle, QuestionBoxProps>(
	({ title, questions }, ref) => {
		...
		// Expose the showNextQuestion method to parent components
									...
									>
										<div className="flex-1">
											...
											>
												<textarea
													id={`question-${index}`}
													className="min-h-[60px] w-full resize-none border-b border-gray-300 bg-transparent p-2 text-white placeholder:text-gray-400 focus:border-blue-500 focus:outline-none"
													...
													onChange={(e) => {
														// This won't be triggered with readOnly, but keeping for consistency
